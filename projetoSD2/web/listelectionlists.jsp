...
<html>
<head>
    <title>iVotas: Menu de Voto - Escolher Lista</title>
        ...
        <div class="row">
            ...
            <div class="col-xs-6 center">
                <div style="margin-left: 20px;">
                    <p>Post in Facebook</p>
                    <s:checkbox name="postFacebook" fieldValue="true" value="true" label="Post in Facebook"/>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12 center">
                <s:submit value="Escolher Lista" cssClass="btn btn-default"/>
            </div>
        </div>
    </s:form>
</div>
